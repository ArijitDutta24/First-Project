...
@mysqli_query($GLOBALS["___msw_sqli"], "delete from `" . DB_PREFIX . "methods` where `method` IN('google','nochex','liqpay','eway','paypoint','beanstream','iris','realex','pay360','jambok','jambot','fetch','paya')");
if (@mysqli_affected_rows($GLOBALS["___msw_sqli"]) > 0) {
  mc_upgradeLog('Completed: obsolete gateways removed');
}

@mysqli_query($GLOBALS["___msw_sqli"], "delete from `" . DB_PREFIX . "methods_params` where `method` IN('google','nochex','liqpay','eway','paypoint','beanstream','iris','realex','pay360','jambok','jambot','fetch','paya')");
if (@mysqli_affected_rows($GLOBALS["___msw_sqli"]) > 0) {
