             ...
             <div class="panel-body productviewarea">
               <div class="row">
                 ...
                 <div class="col-lg-9 col-md-8 pright">
                   ...
                   ?>
                   <div class="addtxt"><?php echo $this->PRODUCT_ADD_TEXT.'Macdee'; ?></div>
                   <?php
                   }
