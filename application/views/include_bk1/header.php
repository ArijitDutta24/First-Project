      ...
      <header>
         ...
         <?php $img = base_url('assets/images/').$contact[5]['setting_value'];?>
            ...
            <ul class="header_nav">
               ...
               <li <?php if ($this->uri->segment(1) == "holiday") { ?> class="active" <?php } ?>><a href="<?php echo base_url();?>holiday">holiday Packages</a></li>
      ...
      <section class="top_info">
         <div class="container clearfix">
            ...
            <ul>
               ...
               <!-- <li><a class="book" id="busket" href="#">BUSKET(<?php echo count($this->cart->contents());?>)</a></li> -->
            
               <?php if(!empty($this->session->userdata('id')))
               {?>
               <li><a href="javascript:void(0)" class="js__popup2 busket">BUSKET(<?php echo count($this->cart->contents());?>)</a></li>
               <li><a class="book" href="<?php echo base_url('Home/logout');?>">LOGOUT</a></li>
            <?php } ?>
            </ul>
         </div>
      </section>