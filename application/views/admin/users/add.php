      ...
      <?php echo $this->utility->showMsg();?>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form id="add_user" name="add_user" class="form-horizontal" enctype="multipart/form-data" method="post" action="<?php echo base_url()?>users/add/<?php echo $this->uri->segment(3);?>" >
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-2 control-label">Full Name</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control required" name="full_name" placeholder="Fullname" value="" >
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control required email" name="email" id="email" placeholder="Please enter email" value="<?php echo set_value('email');?>">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select class="form-control required" name="skills[]" id="skills" multiple="multiple" >
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control required" id="datepicker" name="doj"  value="<?php echo set_value('doj');?>">
                  </div>
                </div>
                <?php
                }
              ...
              <input type="hidden" name="user_type_id" value="<?php echo $this->uri->segment(3);?>">
            </form>
          </div>
          <!-- /.box -->
      ...
      $("#add_user").validate({
        rules: {
          username: {
            required: true,
            remote: {
              url: base_url+'users/check_add_username',
              type: "post"
            }
          },
          email: {
            ...
            email: true,
            remote: {
              url: base_url+'users/check_add_email',
              type: "post"
            }
          }
        },
