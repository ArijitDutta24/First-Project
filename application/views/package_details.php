<?php include('include/header.php');?>
      ...
      ?>
            ...
            <input type="hidden" id='segment' value="<?php echo $this->uri->segment(1);?>">
      <?php }}?>
         ...
         <div class="details_content" id="details_content">
           <div class="panel">
             ...
             <div class="panel_body">
               ...
               <div class="package_details price">
                      ...
                      <?php 
                          ...
                          { 
                             if(!empty($val['pPrice']))
                              {
                                echo '<br>'.$val1['curr_name'].' &nbsp;&nbsp;'.Ocurrency($val['pPrice'], $val1['curr_rate']);
                              }
                              else
                              {
                                echo '<br>'.$val1['curr_name'].' &nbsp;&nbsp;'.number_format(Ocurrency($val['pPrice'], $val1['curr_rate']), 2);
                              }
                          }   
                      ?>
              ...
              <div class="package_details"><span>Package Date: </span> 
                <span>
                  <input type="text" id="datepicker" class="datepicker" placeholder="yyyy-mm-dd">
                </span>
              </div>

              <div class="alert alert-danger" id="btnerror" style="display: none;">
                <p><strong>Warning</strong> <span id="btnerrormsg">Enter the booking date </span></p>
              </div>
               ...
               ?>
				<button class="btn_primary--large mt30" id="booknow" onclick="myFunction()"><img src="<?php echo base_url('assets/images/shopping-cart.svg');?>" width="20" alt=""> Book Now</button>
             </div>
           <?php }?>
...
function insert()
    {
      ...
      if(user == '')
      {
        ...
        $('html, body').animate({
            scrollTop: $("#namecheck").offset().top
        }, 2000);
      ...
      if(email == '')
      {
        ...
        $('html, body').animate({
            scrollTop: $("#emailcheck").offset().top
        }, 2000);
    ...
    //**-------------------Comments Validation-------------------------**//
      ...
      if(comm == '')
      {
        ...
        $('html, body').animate({
            scrollTop: $("#commentcheck").offset().top
        }, 2000);
